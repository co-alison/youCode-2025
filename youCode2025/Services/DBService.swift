...
//            createdAt: nil,
    ...
    // Updates a gear item
    func updateGear(id: Int,
                    currentCondition: String? = nil,
                    latitude: Double? = nil,
                    longitude: Double? = nil,
                    isAvailable: Bool? = nil,
                    gearUIImage: UIImage? = nil) async throws -> GearItem {
        var imageURL: String? = nil
        ...
        // ✅ Always update, with or without image
...
//    }
    ...
    func updateProfile(
        ...
        print("Raw JSON response - updateProfile: \(jsonString)")
